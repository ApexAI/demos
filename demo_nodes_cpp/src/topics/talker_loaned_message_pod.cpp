...
class LoanedMessageTalkerPod : public rclcpp::Node
{
public:
  DEMO_NODES_CPP_PUBLIC
  explicit LoanedMessageTalkerPod(const rclcpp::NodeOptions & options)
  : Node("loaned_message_talker_pod", options)
  {
    ...
    pod_pub_ = this->create_publisher<std_msgs::msg::UInt64>("chatter", qos);
...
private:
  size_t count_ = 1;
  rclcpp::Publisher<std_msgs::msg::UInt64>::SharedPtr pod_pub_;
  rclcpp::TimerBase::SharedPtr timer_;
};

}  // namespace demo_nodes_cpp

RCLCPP_COMPONENTS_REGISTER_NODE(demo_nodes_cpp::LoanedMessageTalkerPod)
