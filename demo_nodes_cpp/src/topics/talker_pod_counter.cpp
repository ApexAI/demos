...
class PodCounterTalker : public rclcpp::Node
{
public:
  DEMO_NODES_CPP_PUBLIC
  explicit PodCounterTalker(const rclcpp::NodeOptions & options)
  : Node("pod_counter_talker", options)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(demo_nodes_cpp::PodCounterTalker)